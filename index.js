...
const todoUi = document.querySelector(".todoPage");
...
function addListBtn() {
  ...
  let cardContainer = document.querySelector(".container2");
...
function uitrip(a) {
  ...
  document.querySelector(".lTitle").style.display = "none";
  document.querySelector(".thead").style.display = "initial";
  document
...
function addListPage() {
  document.querySelector(".lTitle").style.display = "initial";
